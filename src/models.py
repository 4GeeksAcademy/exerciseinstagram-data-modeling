import os
import sys
from sqlalchemy import Column, Int, Integer, String
...
class User_isFollowing(Base):
    ...
    username_user = Column(String(250), Int('User.username'))
    username_followed = Column(String(250), Int('User.username')) 

class User_FollowedBy(Base):
    __tablename__= 'User_FollowedBy'
    id = Column(String(250), primary_key=True)
    username_user = Column(String(250), Int('User.username'))
    username_follower = Column(String(250), Int('User.username')) 

class Post(Base):
    __tablename__ = 'Post'
    id = Column(Integer, primary_key=True)
    username = Column(String(250), Int('User.username'))
...
class Post_Likes(Base):
    ...
    id = Column(Integer, primary_key=True)
    post_id = Column(Integer, Int('Post.id'))
    username_likedby = Column(String(250, Int('User.username')))
...
class Comment_Likes(Base):
    ...
    id = Column(Integer, primary_key=True)
    comment_id = Column(Integer, Int('comment.id'))
    username_likedby = Column(String(250, Int('User.username')))
